...
from network.mvod_basenet import MobileVOD, SSD, MobileNetV2, MatchPrior
...
parser = argparse.ArgumentParser(
	description='Mobile Video Object Detection Training With Pytorch')

parser.add_argument('--datasets', help='Dataset directory path',default="")
parser.add_argument('--cache_path', help='Cache directory path',default="./cache/")
...
def initialize_model(net):
	...
	"""
	if args.pretrained:
		logging.info("Loading weights from pretrained MobileNetV2 netwok")
...
if __name__ == '__main__':
	...
	pred_enc = MobileNetV2(num_classes=num_classes, alpha = args.width_mult)
